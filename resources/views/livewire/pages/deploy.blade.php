...
NFT Factory uses the highest standard to ensure the persistence and integrity of your artwork.
      ...
      <button {{ (($smart_contract && $smart_contract->inReview()) || $state || ($smart_contract && $smart_contract->inDeploying())) ? 'disabled' : 'type="submit"'}}
        ...
        {{ (($smart_contract && $smart_contract->inReview()) || $state || ($smart_contract && $smart_contract->inDeploying())) ? '!bg-gray-600' : '' }}">
