<div>
    ...
    <div class="px-4 md:px-8 relative w-full lg:mx-auto lg:container xl:max-w-screen-lg">
      <div class="py-14 px-12 flex justify-between border border-black bg-black">
        ...
        <button class="px-4 py-2 font-black text-lg bg-NFTF-green hover:bg-white text-white hover:text-black transition duration-150 ease">
          Connect
        </button>
      </div>
    </div>
    ...
    <form action="">
          ...
          <div class="mt-10">
            <div class="md:flex gap-x-10">
              <div class="flex-1 relative flex flex-col">
                ...
                <div>
                  <input class="mt-2 w-full py-2 px-3 block text-lg font-semibold border-2 border-black focus:outline-none focus:ring focus:ring-NFTF-green focus:border-NFTF-green !border-red-600 "
                  type="text" 
                  id="contractname" 
                  name="contractname" 
              ...
              <div class="flex-1 relative flex flex-col">
                ...
                <div>
                  <div class="flex gap-x-10">
                    <label class="mt-6 flex items-start gap-x-4 cursor-pointer !cursor-not-allowed">
                      <input class="w-10 h-10 cursor-pointer shrink-0 !cursor-not-allowed" type="radio" name="blockchain" disabled>
                      <span class="-mt-3 fex flex-col ">
                        <span class="text-xl md:text-2xl font-bold">
                          Yes
                        </span>
                    ...
                    <label class="mt-6 flex items-start gap-x-4  cursor-pointer">
                      <input class="w-10 h-10 cursor-pointer shrink-0" type="radio" name="blockchain" checked>
                      <span class="-mt-3 fex flex-col">
                        <span class="text-xl md:text-2xl font-bold">
                          No
                        </span>
      ...
      <button class="block mx-auto mt-10 mb-14  px-16 py-9 font-bold text-5xl bg-NFTF-green hover:bg-black text-white transition duration-150 ease">
        DEPLOY
      </button>
    </form>
