  ...
  <div class="py-4 d:py-7 px-4 md:px-8 relative w-full lg:mx-auto lg:container xl:max-w-screen-lg">
    ...
    <div class="mt-16 md:flex items-start">
      <div class="md:w-1/2 pr-5 md:sticky top-10">
        <video class="w-full" controls loop playsinline poster="https://i.seadn.io/gcs/files/cfd079410ded682f91b4ade4a064154b.jpg" onmouseover="this.play()" onmouseout="this.pause();this.currentTime=0;">
      ...
      <div class="md:w-1/2 pt-10 md:pt-0 md:pl-5">
        <div>
          ...
          <p class="mt-3 text-lg">
            From the look you can read our past and predict the future. This is because what we experienced shaped the expression of our eyes, but also affects what will happen to us in the future. We can get out of this determinism, provided, however, that we look at the truth of a person straight in the eye... The work is a combination of stop-motion animation collage and photos generated by AI DALL-E A kind of performance about ourselves...
          </p>
          <div class="mt-6 flex justify-between items-center text-xl">
            <div class="font-bold">
              by Magda Americangangsta</a>
            </div>
            <div class="flex gap-4">
              <a class="hover:text-NFTF-green NFTF-transition" 
              href="https://www.instagram.com/magda_americangangsta/"
              target="_blank" 
              ...
              <a class="hover:text-NFTF-green NFTF-transition" 
              href="https://twitter.com/magdagangsta" 
              target="_blank" 
              rel="noopener noreferrer">
                <svg class="w-8 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19 19">
        ...
        <div>
          ...
          <div class="flex gap-10 text-center">
            <a href="https://opensea.io/assets/ethereum/0x495f947276749ce646f68ac8c248420045cb7b5e/98730797835129182241743621246376952627274043155341142829787152145880973312001" target="_blank" class="flex-1 mt-10 px-5 pt-5 pb-7 bg-NFTF-green hover:bg-black text-white text-4xl md:text-6xl font-black NFTF-transition">
                BUY
            </a>
          </div>
        ...
        <div>
          ...
          <ul class="mt-6 text-lg">
            <li>
              <span class="font-bold">Published:</span> March 6th, 2023
            </li>
            <li>
        ...
        <div>
          ...
          <ul class="mt-6 text-lg">
            <li>
              <span class="font-bold">Contract address:</span> 0x495f947276749ce646f68ac8c248420045cb7b5e
            </li>
            <li>
              <span class="font-bold">Type:</span> ERC-1155
            </li>
            <li>
              <span class="font-bold">Blockchain:</span> Ethereum
            </li>
            <li>
              <span class="font-bold">Second market royalties:</span>
                10%
            </li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul class="mt-6 flex gap-4 flex-wrap text-lg">
            <li>
              ...
              href="https://opensea.io/assets/ethereum/0x495f947276749ce646f68ac8c248420045cb7b5e/98730797835129182241743621246376952627274043155341142829787152145880973312001"
              target="_blank"
              rel="noopener noreferrer">
