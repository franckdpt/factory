<div class="py-7 px-4 md:px-8 relative w-full lg:mx-auto lg:container xl:max-w-screen-lg">
  <div class="flex justify-between items-center">
    <a class="flex items-center gap-x-4 text-2xl hover:text-NFTF-green font-bold"
    href="">
      <svg class="w-8 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 476.213 261.213">
        <g transform="translate(476.213 368.713) rotate(180)">
          <path d="M345.606,107.5l-21.212,21.213,94.393,94.394H0v30H418.787L324.394,347.5l21.212,21.213L476.213,238.106Z"/>
        </g>
      </svg>
    ...
    <div class="w-1/2 pl-5">
      <div>
        ...
        <div class="mt-6 flex justify-between items-center text-xl">
          ...
          <div class="flex gap-4">
            <a class="hover:text-NFTF-green NFTFtransition" 
            href="#"
             target="_blank" 
      ...
      <div>
        ...
        <div class="flex gap-10">
          <button class="flex-1 mt-10 px-5 pt-5 pb-7 bg-NFTF-green hover:bg-black text-white text-6xl font-black NFTFtransition">
            BUY
          </button>

          {{-- <div class="flex-1 relative"
          x-data="{ showMessage: false }">
            <button class="relative flex w-full justify-center mt-10 px-5 pt-5 pb-7 border-2 border-black bg-white hover:bg-black hover:text-white text-6xl font-black NFTFtransition z-30"
            x-on:click="showMessage = true; setTimeout(() => { showMessage = false }, 1000) ">
              SHARE
            </button>
            <span class="absolute inset-0 top-8 text-center font-bold text-black tooltip-animation text-2xl z-10"
            x-show="showMessage">
              Link copied!
            </span>
          </div> --}}
      ...
      <div>
        ...
        <ul class="mt-6 flex gap-4 flex-wrap text-lg">
          <li>
            <a class="px-6 py-2 flex items-center gap-x-3 bg-black hover:bg-NFTF-green text-white hover:bg NFTFtransition"
            href="#"
            target="_blank"
            rel="noopener noreferrer">
  ...
  <script>
    document.addEventListener('DOMContentLoaded', function () {
      // reduce flash UI
      // @this.auth_address = formatAddress(getAccount().address)
    })
  </script>
</div>