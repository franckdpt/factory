...
<div
    ...
    {{ $attributes->class(['filament-global-search-results-container absolute left-0 rtl:right-auto rtl:left-0 top-auto z-10 mt-2 shadow-xl overflow-hidden rounded-xl w-screen max-w-xs sm:max-w-lg']) }}
>
    <div @class([
